...
const ZH_CN = {
  ...
  PLEASE_INPUT_PRINCIPAL: "请输入账户名",
  PLEASE_INPUT_PASSWORD: "请输入密码",
  NONEXISTENT_PRINCIPAL: "账户名不存在",
  INCORRECT_PASSWORD: "密码不正确",

  WRITER_PRINCIPAL: "作者代号(仅包含英文字母及数字)",
  WRITER_LIST: "作者列表",
  ...
  ORG_DETAIL: "组织机构详情",
  ORG_PRINCIPAL: "组织机构代号(仅包含英文字母及数字)",
  ORG_LIST: "组织机构列表",
  ...
  WRITER_PRINCIPAL_DUPLICATED: "作者代号已被使用",
  ORG_OR_WRITER_PRINCIPAL_DUPLICATED: "组织架构代号或作者代号已被使用",
